...
public class ListUtils {
    ...
    public static <V> boolean isSetEmpty(Set<V> sourceSet) {
        return (sourceSet == null || sourceSet.size() == 0 || sourceSet.isEmpty());
    }

    public static <V> boolean isEmptySparseArray(SparseArray<V> sourceArray) {
        return (sourceArray==null || sourceArray.size()==0||sourceArray.valueAt(0)==null);
    }

    public static <V> boolean isEmptyHashMap(HashMap<Integer,String> sourceMap) {
        return (sourceMap==null || sourceMap.size()==0||sourceMap.isEmpty());
    }
    ...
    public static <V> boolean isEmpty(List<V> sourceList) {
        return (sourceList == null || sourceList.size() == 0 || sourceList.get(0)==null);
    }
     ...
     * @return
     */
    /*public static <V> V[] toArray(List<V> sourceList) {
        V[] targetArr = new V[sourceList.size()];

        return sourceList.toArray(targetArr);
    }*/
}
