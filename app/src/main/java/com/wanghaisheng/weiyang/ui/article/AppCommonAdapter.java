...
/**
 * Created by sheng on 2016/6/14.
 * 公共的多种item type 的adapter
 */
public class AppCommonAdapter extends MultiItemCommonAdapter<BaseBean> {
    ...
    public AppCommonAdapter(Context context, List<BaseBean> datas) {
